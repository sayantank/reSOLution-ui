...
export const programId = new PublicKey(
	"6nGFQ3vek6SST6AhmfCeii2pj7GK2yiF2FkgeJUvXJPU",
);

export const deprecated_programId = new PublicKey(
...
export type Resolution = {
	address: "6nGFQ3vek6SST6AhmfCeii2pj7GK2yiF2FkgeJUvXJPU";
	metadata: {
		name: "resolution";
		version: "0.1.0";
		spec: "0.1.0";
 ...
 * IDL can be found at `target/idl/resolution.json`.
 */
export type Deprecated_Resolution = {
